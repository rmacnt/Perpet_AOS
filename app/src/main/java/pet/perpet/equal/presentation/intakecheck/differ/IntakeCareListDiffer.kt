package pet.perpet.equal.presentation.intakecheck.differ
...
class IntakeCareListDiffer {
    ...
    val adapter: BaseRecyclerViewAdapter by lazy {
        object : BaseRecyclerViewAdapter(provider) {
            override fun onCreateItemViewHolder(
                ...
                return ItemCareViewHolder(parent)
            }
        }.apply {
    ...
    fun snapList(): List<IntakeCare> {
        val newList = mutableListOf<IntakeCare>()
        newList.addAll(dataSet.filterIsInstance<IntakeCare>())
        return newList
    }

    private fun calDiff(newTiles: List<Any>) {
        val intakeCareListDifferCallback = IntakeCareListDifferCallback(dataSet, newTiles)
        val diffResult: DiffUtil.DiffResult = DiffUtil.calculateDiff(intakeCareListDifferCallback)
    ...
    private fun createItemCallback(): DiffUtil.ItemCallback<IntakeCare> {
        return object : DiffUtil.ItemCallback<IntakeCare>() {
...
class IntakeCareListDifferCallback(
