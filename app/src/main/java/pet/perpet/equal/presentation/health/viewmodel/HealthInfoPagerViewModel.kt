...
import pet.perpet.equal.presentation.health.fragment.HealthInfoPagerFragmentArgs
import pet.perpet.framework.fragment.UseViewModel

class HealthInfoPagerViewModel (fragment: Fragment) : UseViewModel(fragment) {

    private val args by lazy {
        HealthInfoPagerFragmentArgs.fromBundle(arguments)
    }
