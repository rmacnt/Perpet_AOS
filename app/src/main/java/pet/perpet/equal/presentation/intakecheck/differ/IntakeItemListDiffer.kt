...
class IntakeItemListDiffer(type: Boolean) {
    ...
    val adapter: BaseRecyclerViewAdapter by lazy {
        object : BaseRecyclerViewAdapter(provider) {
            override fun onCreateItemViewHolder(
                ...
                return ItemIntakeViewHolder(parent , type)
            }
        }.apply {
    ...
    private fun calDiff(newTiles: List<Any>) {
        val intakeItemListDifferCallback = IntakeItemListDifferCallback(dataSet, newTiles)
        val diffResult: DiffUtil.DiffResult = DiffUtil.calculateDiff(intakeItemListDifferCallback)
...
class IntakeItemListDifferCallback(
