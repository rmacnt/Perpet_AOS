...
class SearchListDiffer {
    ...
    val adapter : BaseRecyclerViewAdapter by lazy {
        object : BaseRecyclerViewAdapter(provider) {
            override fun onCreateItemViewHolder(
                ...
                return SearchSimpleViewHolder(parent)
            }
        }.apply {
    ...
    private fun calDiff(newTiles: List<Any>) {
        val searchListDifferCallback = SearchListDifferCallback(dataSet, newTiles)
        val diffResult: DiffUtil.DiffResult = DiffUtil.calculateDiff(searchListDifferCallback)
...
class SearchListDifferCallback(
