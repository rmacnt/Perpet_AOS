...
import pet.perpet.equal.databinding.SearchFaqFragmentBinding
import pet.perpet.equal.presentation.search.viewmodel.SearchFaqViewModel
...
class SearchFaqFragment : AbstractSwipePagerRecyclerViewFragment<SearchFaqViewModel>() {

    //======================================================================
    // Variables
    //======================================================================

    lateinit var binding: SearchFaqFragmentBinding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.search_faq_fragment, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding = SearchFaqFragmentBinding.bind(view)
