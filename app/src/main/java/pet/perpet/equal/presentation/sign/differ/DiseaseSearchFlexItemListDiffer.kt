...
class DiseaseSearchFlexItemListDiffer  {
    ...
    val adapter: BaseRecyclerViewAdapter by lazy {
        object : BaseRecyclerViewAdapter(provider) {
            override fun onCreateItemViewHolder(
                ...
                return DiseaseSearchFlexItemViewHolder(parent)
            }
        }.apply {
    ...
    private fun calDiff(newTiles: List<Any>) {
        val diseaseSearchFlexItemListDifferCallback = DiseaseSearchFlexItemListDifferCallback(dataSet, newTiles)
        val diffResult: DiffUtil.DiffResult = DiffUtil.calculateDiff(diseaseSearchFlexItemListDifferCallback)
...
class DiseaseSearchFlexItemListDifferCallback(
