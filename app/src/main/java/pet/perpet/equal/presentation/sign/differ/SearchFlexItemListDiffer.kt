...
class SearchFlexItemListDiffer {
    ...
    private fun calDiff(newTiles: List<Any>) {
        val searchFlexDiffUtilCallback = SearchFlexDiffUtilCallback(dataSet, newTiles)
        val diffResult: DiffUtil.DiffResult = DiffUtil.calculateDiff(searchFlexDiffUtilCallback)
...
class SearchFlexDiffUtilCallback(
