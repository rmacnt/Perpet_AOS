package pet.perpet.data.repository.subscribe
...
class SubscribeInsertRepository : Repository<SubscribeInsertRepository.Parameter, Any>() {
    ...
    override fun createRemoteDataSource(): RemoteDataSource<Parameter, *, *> {
        ...
        return object :
            ...
            override fun fetchApi(param: Parameter?): ApiCall<DefaultResponse> {
                return Client.main.setSubscribe(
                    subscribeRequest = param?.subscribeRequest,
                )
            }
    ...
    open class Parameter {
        var subscribeRequest: SubscribeRequest? = null
    }
}