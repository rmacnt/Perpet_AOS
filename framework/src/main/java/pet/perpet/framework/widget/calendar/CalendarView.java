package pet.perpet.framework.widget.calendar;


import static pet.perpet.framework.widget.calendar.utils.CalendarProperties.FIRST_VISIBLE_PAGE;
...
import pet.perpet.framework.widget.calendar.exceptions.OutOfDateRangeException;
import pet.perpet.framework.widget.calendar.extensions.CalendarViewPager;
...
import pet.perpet.framework.widget.calendar.utils.AppearanceUtils;
...
public class CalendarView extends LinearLayout {
    ...
    public void setWeekDaySelectProcess(boolean weekDaySelectProcess) {
        mCalendarProperties.setWeekDaySelectProcess(weekDaySelectProcess);
    }

    public void setOnWeekClickListener(OnWeekClickListener onWeekClickListener) {
        mCalendarProperties.setOnWeekClickListener(onWeekClickListener);
    }
