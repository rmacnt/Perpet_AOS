package pet.perpet.framework.widget.calendar.utils;
...
import pet.perpet.framework.widget.calendar.exceptions.ErrorsMessages;
import pet.perpet.framework.widget.calendar.exceptions.UnsupportedMethodsException;
import pet.perpet.framework.widget.calendar.listeners.OnCalendarPageChangeListener;
import pet.perpet.framework.widget.calendar.listeners.OnDayClickListener;
import pet.perpet.framework.widget.calendar.listeners.OnSelectDateListener;
import pet.perpet.framework.widget.calendar.listeners.OnSelectionAbilityListener;
import pet.perpet.framework.widget.calendar.listeners.OnWeekClickListener;
...
public class CalendarProperties {
    ...
    boolean weekDaySelectProcess;

    public boolean isWeekDaySelectProcess() {
        return weekDaySelectProcess;
    }

    public void setWeekDaySelectProcess(boolean weekDaySelectProcess) {
        this.weekDaySelectProcess = weekDaySelectProcess;
    }
    ...
    public OnWeekClickListener getOnWeekClickListener() {
        return mOnWeekClickListener;
    }

    public void setOnWeekClickListener(OnWeekClickListener mOnWeekClickListener) {
        this.mOnWeekClickListener = mOnWeekClickListener;
    }
}
